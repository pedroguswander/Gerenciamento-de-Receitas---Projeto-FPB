def filtrar_por_pais(receitas_por_pais,lista_de_pais,receitas,nome_da_receita,conteudo_de_cada_receita) :
    pais = receitas[nome_da_receita][conteudo_de_cada_receita[0]]
    receitas_por_pais[pais] = lista_de_pais
    receitas_por_pais[pais].append(nome_da_receita)
